public class Container extends Item {
    ...
    public String getDescription() {
        ...
        if(this.isOpen && this.contents == null) {
            ...
            return this.getDescription() + " containing a " + this.contents.getDescription();
        } else {
            return "closed " + this.getDescription();
        }
    }
    ...
    public int getWeight() {
        ...
        if (this.contents == null) {
            ...
            return (int)(this.getWeight() + this.contents.getWeight());
        }
    }

...
public class MysticHallway {
    ...
    public static void main(String args[]) {
        ...
        while(playing) {
            ...
            System.out.println("From here you can go " + directions + ", (p)ick up, or (q)uit");
            ...
            if (command.startsWith("l")) {
                ...
                if (inventory != null) {
                    System.out.println("You find " + inventory.getDescription());
                } else {
                ...
                System.out.println("The commands are: go (l)eft, go (r)ight, (p)ick up, and (q)uit.");
            }
        }
    }
}
